...
namespace Enjin.SDK.ProjectSchema
{
    ...
    [PublicAPI]
    public class DecreaseMaxMeltFee : GraphqlRequest<DecreaseMaxMeltFee>,
                                      ITransactionRequestArguments<DecreaseMaxMeltFee>
    {
        /// <summary>
        /// Sole constructor.
        /// </summary>
        ...
        public DecreaseMaxMeltFee AssetId([CanBeNull] string assetId)
        {
