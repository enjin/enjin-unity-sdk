...
namespace Enjin.SDK.Events
{
    internal sealed class ProjectChannel : IChannel
    {
        ...
        {
            return $"enjincloud.{_platform.Network.ToLower()}.project.{_projectUuid}";
        }
    }
    ...
    internal sealed class PlayerChannel : IChannel
    {
        ...
        public string Channel()
        {
            return $"enjincloud.{_platform.Network.ToLower()}.project.{_projectUuid}.player.{_playerId}";
        }
    }
    ...
    internal sealed class AssetChannel : IChannel
    {
        ...
        public string Channel()
        {
            return $"enjincloud.{_platform.Network.ToLower()}.asset.{_assetId}";
        }
    }
    ...
    internal sealed class WalletChannel : IChannel
    {
        ...
        public string Channel()
        {
            return $"enjincloud.{_platform.Network.ToLower()}.wallet.{_ethAddress}";
        }
    }
}