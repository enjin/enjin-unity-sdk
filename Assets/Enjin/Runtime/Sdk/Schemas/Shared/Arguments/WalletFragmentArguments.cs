...
namespace Enjin.SDK.Shared
{
    ...
    {
        /// <summary>
        /// Sets the balance filter when used with <see cref="WithWalletBalance{T}"/>.
        /// </summary>
        ...
        public static T WalletBalanceFilter<T>(this T instance, [CanBeNull] BalanceFilter filter)
        ...
        /// <summary>
        /// Sets the request to include the assets of the wallet.
        /// </summary>
        /// <param name="instance">The caller.</param>
        /// <typeparam name="T">The caller type.</typeparam>
        /// <returns>The caller for chaining.</returns>
        ...
        public static T WithWalletBalance<T>(this T instance) where T : IWalletFragmentArguments<T>
        {
            return instance.SetVariable("withWalletBalance", true);
        }
