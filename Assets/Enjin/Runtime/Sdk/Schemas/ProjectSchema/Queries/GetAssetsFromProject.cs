...
namespace Enjin.SDK.ProjectSchema
{
                                        ...
                                        IPaginationArguments<GetAssetsFromProject>
    {
        ...
        public GetAssetsFromProject Projects([CanBeNull] params string[] projects)
        {
        ...
        /// <returns>This request for chaining.</returns>
        public GetAssetsFromProject Filter([CanBeNull] AssetFilter filter)
        {
        ...
        /// <returns>This request for chaining.</returns>
        public GetAssetsFromProject Sort([CanBeNull] AssetSortInput sort)
        {
