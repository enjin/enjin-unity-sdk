...
namespace Enjin.SDK.PlayerSchema
{
    ...
    public class SendAsset : GraphqlRequest<SendAsset>, ITransactionFragmentArguments<SendAsset>
    {
        ...
        public SendAsset RecipientAddress([CanBeNull] string recipientAddress)
        {
        ...
        /// <returns>This request for chaining.</returns>
        public SendAsset AssetId([CanBeNull] string assetId)
        {
        ...
        /// <returns>This request for chaining.</returns>
        public SendAsset AssetIndex([CanBeNull] string assetIndex)
        {
        ...
        /// <returns>This request for chaining.</returns>
        public SendAsset Value([CanBeNull] string value)
        {
        ...
        /// <returns>This request for chaining.</returns>
        public SendAsset Data([CanBeNull] string data)
        {
