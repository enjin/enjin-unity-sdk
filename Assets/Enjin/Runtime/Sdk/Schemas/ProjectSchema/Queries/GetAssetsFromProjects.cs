...
namespace Enjin.SDK.ProjectSchema
{
                                        ...
                                        IPaginationArguments<GetAssetsFromProjects>
    {
        ...
        public GetAssetsFromProjects Projects([CanBeNull] params string[] projects)
        {
            return SetVariable("project", projects);
        }
        ...
        /// <returns>This request for chaining.</returns>
        public GetAssetsFromProjects Filter([CanBeNull] AssetFilter filter)
        {
        ...
        /// <returns>This request for chaining.</returns>
        public GetAssetsFromProjects Sort([CanBeNull] AssetSortInput sort)
        {
