...
namespace Enjin.SDK.Shared
{
    ...
    [PublicAPI]
    public class GetAssets : GraphqlRequest<GetAssets>,
                             IAssetFragmentArguments<GetAssets>,
                             IPaginationArguments<GetAssets>
    {
        /// <summary>
        /// Sole constructor.
        /// </summary>
        ...
        public GetAssets Filter([CanBeNull] AssetFilter filter)
        {
        ...
        /// <returns>This request for chaining.</returns>
        public GetAssets Sort([CanBeNull] AssetSortInput sort)
        {
