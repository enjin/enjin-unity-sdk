...
namespace Enjin.SDK.ProjectSchema
{
    ...
    public class CreateAsset : GraphqlRequest<CreateAsset>, ITransactionRequestArguments<CreateAsset>
    {
        ...
        public CreateAsset Name([CanBeNull] string name)
        {
        ...
        /// <returns>This request for chaining.</returns>
        public CreateAsset TotalSupply([CanBeNull] string totalSupply)
        {
        ...
        /// <returns>This request for chaining.</returns>
        public CreateAsset InitialReserve([CanBeNull] string initialReserve)
        {
        ...
        /// <returns>This request for chaining.</returns>
        public CreateAsset MeltValue([CanBeNull] string meltValue)
        {
        ...
        /// <returns>This request for chaining.</returns>
        public CreateAsset TransferFeeSettings([CanBeNull] AssetTransferFeeSettingsInput transferFeeSettings)
        {
