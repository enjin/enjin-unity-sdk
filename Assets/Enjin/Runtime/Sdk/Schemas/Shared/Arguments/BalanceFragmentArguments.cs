...
namespace Enjin.SDK.Shared
{
    ...
    public static class BalanceFragmentArguments
    {
        ...
        public static T BalIdFormat<T>(this T instance, AssetIdFormat? balIdFormat)
            where T : IBalanceFragmentArguments<T>
        {
        ...
        /// <typeparam name="T">The caller type.</typeparam>
        /// <returns>The caller for chaining.</returns>
        public static T BalIndexFormat<T>(this T instance, AssetIndexFormat? balIndexFormat)
            where T : IBalanceFragmentArguments<T>
        {
