...
namespace Enjin.SDK.ProjectSchema
{
    ...
    public class CreateTrade : GraphqlRequest<CreateTrade>, ITransactionRequestArguments<CreateTrade>
    {
        ...
        public CreateTrade AskingAssets([CanBeNull] params TradeInput[] assets)
        {
        ...
        /// <param name="assets">The assets.</param>
        /// <returns>This request for chaining.</returns>
        public CreateTrade OfferingAssets([CanBeNull] params TradeInput[] assets)
        {
        ...
        /// <returns>This request for chaining.</returns>
        public CreateTrade RecipientAddress([CanBeNull] string recipientAddress)
        {
