...
namespace Enjin.SDK.ProjectSchema
{
    ...
    public class SetWhitelisted : GraphqlRequest<SetWhitelisted>, ITransactionRequestArguments<SetWhitelisted>
    {
        ...
        public SetWhitelisted AssetId([CanBeNull] string assetId)
        {
        ...
        /// <returns>This request for chaining.</returns>
        public SetWhitelisted AccountAddress([CanBeNull] string accountAddress)
        {
        ...
        /// <returns>This request for chaining.</returns>
        public SetWhitelisted WhitelistedAddress([CanBeNull] string whitelistedAddress)
        {
