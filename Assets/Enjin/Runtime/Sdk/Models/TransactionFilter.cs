...
namespace Enjin.SDK.Models
{
    ...
    public class TransactionFilter : Filter<TransactionFilter>
    {
        ...
        public TransactionFilter Id([CanBeNull] string id)
        {
            _id = id;
            return this;
        }
        ...
        /// <returns>This filter for chaining.</returns>
        public TransactionFilter IdIn([CanBeNull] params string[] ids)
        {
            _idIn = ids?.ToList();
            return this;
        }
        ...
        /// <returns>This filter for chaining.</returns>
        public TransactionFilter TransactionId([CanBeNull] string transactionId)
        {
        ...
        /// <returns>This filter for chaining.</returns>
        public TransactionFilter TransactionIdIn([CanBeNull] params string[] transactionIds)
        {
        ...
        /// <returns>This filter for chaining.</returns>
        public TransactionFilter AssetId([CanBeNull] string assetId)
        {
            _assetId = assetId;
            return this;
        }
        ...
        /// <returns>This filter for chaining.</returns>
        public TransactionFilter AssetIdIn([CanBeNull] params string[] assetIds)
        {
        ...
        /// <returns>This filter for chaining.</returns>
        public TransactionFilter Types([CanBeNull] params TransactionType[] types)
        {
        ...
        /// <returns>This filter for chaining.</returns>
        public TransactionFilter StateIn([CanBeNull] params TransactionState[] states)
        {
        ...
        /// <returns>This filter for chaining.</returns>
        public TransactionFilter Wallet([CanBeNull] string wallet)
        {
            _wallet = wallet;
            return this;
        }
        ...
        /// <returns>This filter for chaining.</returns>
        public TransactionFilter WalletIn([CanBeNull] params string[] wallets)
        {
