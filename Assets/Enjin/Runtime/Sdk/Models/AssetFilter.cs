...
namespace Enjin.SDK.Models
{
    ...
    public class AssetFilter : Filter<AssetFilter>
    {
        ...
        public AssetFilter Id([CanBeNull] string id)
        {
            _id = id;
            return this;
        }
        ...
        /// <returns>This filter for chaining.</returns>
        public AssetFilter IdIn([CanBeNull] params string[] ids)
        {
            _idIn = ids?.ToList();
            return this;
        }
        ...
        /// <returns>This filter for chaining.</returns>
        public AssetFilter Name([CanBeNull] string name)
        {
            _name = name;
            return this;
        }
        ...
        /// <returns>This filter for chaining.</returns>
        public AssetFilter NameContains([CanBeNull] string text)
        {
            _nameContains = text;
            return this;
        }
        ...
        /// <returns>This filter for chaining.</returns>
        public AssetFilter NameIn([CanBeNull] params string[] names)
        {
        ...
        /// <returns>This filter for chaining.</returns>
        public AssetFilter NameStartsWith([CanBeNull] string prefix)
        {
        ...
        /// <returns>This filter for chaining.</returns>
        public AssetFilter NameEndsWith([CanBeNull] string suffix)
        {
        ...
        /// <returns>This filter for chaining.</returns>
        public AssetFilter Wallet([CanBeNull] string wallet)
        {
            _wallet = wallet;
            return this;
        }
        ...
        /// <returns>This filter for chaining.</returns>
        public AssetFilter WalletIn([CanBeNull] params string[] addresses)
        {
