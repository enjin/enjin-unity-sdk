...
namespace Enjin.SDK.Shared
{
    ...
    [PublicAPI]
    public class GetBalances : GraphqlRequest<GetBalances>,
                               IBalanceFragmentArguments<GetBalances>,
                               IPaginationArguments<GetBalances>
    {
        /// <summary>
        /// Sole constructor.
        /// </summary>
        ...
        public GetBalances Filter([CanBeNull] BalanceFilter filter)
        {
